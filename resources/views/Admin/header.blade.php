...
<head>
  ...
  <!-- Google Fonts -->
  <link href="{{url('adminassets/')}}/https://fonts.gstatic.com" rel="preconnect">
  <link href="{{url('adminassets/')}}/https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Nunito:300,300i,400,400i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{url('adminassets/')}}/index.html" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="{{url('adminassets/')}}/#">
                <img src="{{url('adminassets/')}}/assets/img/messages-3.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{url('adminassets/')}}/users-profile.html">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{url('adminassets/')}}/pages-faq.html">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{url('adminassets/')}}/#">
