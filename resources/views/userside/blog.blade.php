			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0">
						<div class="card-header p-0">
							<a href="single.html">
								<img src="{{url('useraseets/')}}/images/blog1.png" class="card-img-bottom img-fluid" alt="image">
							</a>
							<img src="{{url('useraseets/')}}/images/te1.jpg" alt="" class="img-blog rounded-circle img-fluid">
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0">
						<div class="card-header p-0">
							<a href="single.html">
								<img src="{{url('useraseets/')}}/images/blog2.png" class="card-img-bottom img-fluid" alt="image">
							</a>
							<img src="{{url('useraseets/')}}/images/te2.jpg" alt="" class="img-blog rounded-circle img-fluid">
						</div>
						<div class="card-body text-center pt-5 mt-2">
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
					<div class="card border-0">
						<div class="card-header p-0">
							<a href="single.html">
								<img src="{{url('useraseets/')}}/images/blog3.png" class="card-img-bottom img-fluid" alt="image">
							</a>
							<img src="{{url('useraseets/')}}/images/te3.jpg" alt="" class="img-blog rounded-circle img-fluid">
						</div>
						<div class="card-body text-center pt-5 mt-2">
