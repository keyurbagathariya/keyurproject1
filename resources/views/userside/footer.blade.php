			...
			<div class="row footer-top">
				...
				<div class="col-lg-4 footer-grid_section_1its my-lg-0 my-sm-4 my-4">
					...
					<div class="footer-text mt-4">
						...
						<p class="my-2">Phone : +91 9725288220</p>
						<p>Email : <a href="mailto:info@example.com">bagathariyakeyur7600@gmail.com</a></p>
					</div>
					...
					<ul class="list-unstyled payment-links mt-4">
						<li>
							<a href="#"><img src="{{url('userassets/')}}/images/pay2.png" alt=""></a>
						</li>
						<li>
							<a href="#"><img src="{{url('userassets/')}}/images/pay5.png" alt=""></a>
						</li>
						<li>
							<a href="#"><img src="{{url('userassets/')}}/images/pay1.png" alt=""></a>
						</li>
						<li>
							<a href="#"><img src="{{url('userassets/')}}/images/pay4.png" alt=""></a>
						</li>
					</ul>
				</div>
